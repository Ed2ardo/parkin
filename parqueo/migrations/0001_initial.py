    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('placa', models.CharField(blank=True, max_length=10, null=True, validators=[django.core.validators.RegexValidator(message='Formato de placa inválido (solo mayúsculas, números y guiones).', regex='^[A-Z0-9-]{6,10}$')], verbose_name='Placa del Vehículo')),
